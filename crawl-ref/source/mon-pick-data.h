...
// Pretty weak, but not quite bottom tier.
  ...
  {  1,  4,  515, SEMI, MONS_GIANT_COCKROACH },
  ...
  {  1,  5,  515, SEMI, MONS_QUOKKA },
  {  1,  5,  335, SEMI, MONS_JACKAL },
  {  1,  8,  192, PEAK, MONS_GNOLL },
...
// These historically don't get kills after D:7ish.
  {  4,  7,  515, SEMI, MONS_SCORPION },
  {  4,  7,  925, FLAT, MONS_WORKER_ANT },
  {  4,  7,  825, SEMI, MONS_HOUND },
  {  4,  7,  350, FLAT, MONS_UFETUBUS },
  {  4,  7,  825, SEMI, MONS_OGRE },
  {  4,  7,  515, SEMI, MONS_IGUANA },
  {  4,  7,  335, SEMI, MONS_PHANTOM },
  {  4,  7, 1000, FLAT, MONS_SKELETON },
  {  4,  8,  515, SEMI, MONS_JELLY },
  {  4,  8,  192, PEAK, MONS_NECROPHAGE },
  {  4,  8,  310, SEMI, MONS_BLACK_BEAR },

  {  4, 10,   52, SEMI, MONS_GNOLL_SHAMAN },
  {  4, 12,  136, SEMI, MONS_ORC_PRIEST },
  {  4, 14,  515, SEMI, MONS_ORC_WIZARD },
  {  4, 14,  335, SEMI, MONS_HOWLER_MONKEY },
  {  5,  8,  450, FLAT, MONS_WHITE_IMP },
  {  5,  8,  300, FLAT, MONS_SHADOW_IMP },
  {  5,  8,  192, PEAK, MONS_QUASIT },
  {  5,  8,  515, SEMI, MONS_ICE_BEAST },
  {  5,  8,  515, SEMI, MONS_SKY_BEAST },
  {  5,  9,  215, PEAK, MONS_WATER_MOCCASIN },
  {  5, 11, 1000, FLAT, MONS_ZOMBIE },
  {  5, 13,  825, SEMI, MONS_CENTAUR },
  {  5, 13,   89, PEAK, MONS_GNOLL_SERGEANT },

  {  6,  9, 1025, FLAT, MONS_BULLFROG },
  {  6, 10,  500, SEMI, MONS_WIGHT },
  {  6, 10,   89, PEAK, MONS_STEAM_DRAGON },
  {  6, 11,  415, SEMI, MONS_KOBOLD_BRIGAND },
  {  6, 12,  860, SEMI, MONS_ORC_WARRIOR },
  {  7, 10,  220, PEAK, MONS_SOLDIER_ANT },
  {  7, 11,  470, SEMI, MONS_KILLER_BEE },
  {  7, 11,  192, PEAK, MONS_HORNET },
  {  7, 11,  335, SEMI, MONS_WYVERN },
  {  8, 12,  850, SEMI, MONS_YAK },
  {  8, 14,  335, SEMI, MONS_ACID_DRAGON },
  {  8, 17,  675, SEMI, MONS_TWO_HEADED_OGRE },
  {  9, 13,  380, SEMI, MONS_SHADOW },
  {  9, 14,  235, SEMI, MONS_KOBOLD_DEMONOLOGIST },
  {  9, 14,  500, SEMI, MONS_WRAITH },
  {  9, 14,  825, SEMI, MONS_TROLL },
  {  9, 14,  192, PEAK, MONS_VAMPIRE },
  { 10, 13,  515, SEMI, MONS_UNSEEN_HORROR },
  { 10, 13,  215, PEAK, MONS_KOMODO_DRAGON },
  { 10, 14,  370, SEMI, MONS_GARGOYLE },
  { 10, 15,  500, SEMI, MONS_VAMPIRE_MOSQUITO },
